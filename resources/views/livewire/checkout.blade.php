<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="{{ route('keranjang') }}" class="btn btn-sm btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
        ...
        <div class="col">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    No. Rekening 0000000-00000 atas nama <strong>Muhammad Rizki</strong>
                </div>
            </div>
        </div>
        <div class="col">
